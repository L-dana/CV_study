...
img_result = cv.morphologyEx(img_gray, cv.MORPH_OPEN, kernal)

cv.namedWindow('Original', cv.WINDOW_NORMAL)
cv.namedWindow('Opening_Result', cv.WINDOW_NORMAL)

cv.imshow('Original', img_gray)
cv.imshow('Opening_Result', img_result)
